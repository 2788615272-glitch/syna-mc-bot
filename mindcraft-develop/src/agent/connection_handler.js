...
export function shouldRestartAfterDisconnect(type) {
    // These are usually configuration/login problems and will loop forever if auto-restarted.
    return !['name_conflict', 'access_denied', 'version_mismatch'].includes(type);
}
